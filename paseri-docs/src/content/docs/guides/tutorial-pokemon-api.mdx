...
full list of options can be found in the [reference](/reference/schema/collections/object/).
:::

Now that you've had a taste of what Paseri can do, you can explore the full [API documentation](/reference/schema/common/).
Happy parsing!
