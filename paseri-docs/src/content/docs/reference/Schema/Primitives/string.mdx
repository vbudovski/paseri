...
<Playground
    schemaDefaultValue={"p.string(p.minLength(3))"}
...
```typescript
p.string(p.isoTime({ precision: 3 }));
// 01:02:03.123 ✅
// 01:02:03.1234 ❌
```
