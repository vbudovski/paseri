...
const _schema: StandardSchemaV1<unknown, {
    ...
    safeParse: typeof safeParseObjectNested;
    parse: typeof parseObjectNested;
} = {
    "~standard": {
        version: 1,
        vendor: "paseri",
    ...
    safeParse: safeParseObjectNested,
    parse: parseObjectNested
};

export { _schema as ObjectNested };
