...
function _slowObjectSimple(value: unknown): ParseResult<{
    "foo": string;
}> {
...
export function safeParseObjectSimple(value: unknown): ParseResult<{
    "foo": string;
}> {
    if (!(isPlainObject(value))) {
...
export function parseObjectSimple(value: unknown): {
    "foo": string;
} {
