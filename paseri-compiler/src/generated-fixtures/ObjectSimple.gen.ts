...
const _schema: StandardSchemaV1<unknown, {
    ...
    safeParse: typeof safeParseObjectSimple;
    parse: typeof parseObjectSimple;
} = {
    "~standard": {
        version: 1,
        vendor: "paseri",
    ...
    safeParse: safeParseObjectSimple,
    parse: parseObjectSimple
};

export { _schema as ObjectSimple };
